  ...
  <div className="min-h-screen bg-background font-logo">
    <div className="container py-8">
      ...
      <section className="mb-12">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold text-neutral-dark font-headings">
            Categories {categories?.data?.length ? `(${categories.data.length})` : ''}
          </h2>
          <button
                ...
                categories.data.map((category) => (
                  ...
                  >
                    ...
                    <td className="p-4 flex gap-4">
                      ...
                      <button
                        onClick={() => openDeleteModal('category', category._id)}
      ...
      <section className="mb-12">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold text-neutral-dark font-headings">
            Products {products?.data?.length ? `(${products.data.length})` : ''}
          </h2>
          <button
          ...
          <table className="min-w-full text-neutral-dark font-text">
            ...
            <tbody>
              {productsLoading ? (
                ...
                <tr>
                  <td colSpan="5" className="p-4 text-center">No products</td>
                </tr>
              )}
            </tbody>
          </table>
      ...
      <Modal
        ...
        title={productModal.mode === 'create' ? 'Add Product' : 'Edit Product'}
        size="lg"
        footer={
          <>
            <button
      ...
      >
        <form onSubmit={handleProductSubmit} className="space-y-4 font-text">
          ...
          <div>
            <label htmlFor="price" className="block text-sm font-medium text-neutral-dark">
              Price (₹)
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="stock" className="block text-sm font-medium text-neutral-dark">
              Stock
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="image" className="block text-sm font-medium text-neutral-dark">
              Product Image
            </label>
            <input
              type="file"
        ...
        footer={
          <>
            ...
            <button
              ...
              disabled={deleteCategoryMutation.isLoading || deleteProductMutation.isLoading}
            >
              {deleteCategoryMutation.isLoading || deleteProductMutation.isLoading ? (
                <FaSpinner className="animate-spin inline mr-2" />
              ) : (
                'Yes'
              )}
