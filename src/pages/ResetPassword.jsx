                ...
                <form onSubmit={handleSubmit} method="POST" action="#" className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            className={`w-full border-2 border-neutral-light rounded-md p-2 focus:ring-2 focus:ring-primary focus:border-primary ${formErrors.email ? 'border-error' : ''
                                }`}
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            className={`w-full border-2 border-neutral-light rounded-md p-2 focus:ring-2 focus:ring-primary focus:border-primary ${formErrors.otp ? 'border-error' : ''
                                }`}
                            disabled={isSubmitting}
                        />
