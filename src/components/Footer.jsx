        ...
        <footer className="bg-neutral-dark text-secondary py-8">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left font-text">
                <div>
                    ...
                    <p className="text-sm">Your one-stop shop for the latest tech gadgets.</p>
                </div>

                <div>
                    <h4 className="text-lg font-semibold mb-4 font-headings">Quick Links</h4>
                    <ul className="space-y-2 text-sm">
                        ...
                        <li>
                            <Link to="/cart" className="hover:text-accent transition hover:cursor-pointer">
                                Cart
                            </Link>
                        </li>
                        <li>
                ...
                <div>
                    <h4 className="text-lg font-semibold mb-4 font-headings">Follow Us</h4>
                    <div className="flex justify-center md:justify-start space-x-4">
                        <a href="https://github.com/Gurpreet-Singh-01" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition">
                            <FaGithub size={24} />
                        </a>
