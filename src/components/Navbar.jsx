        ...
        <nav className="bg-primary text-secondary shadow-md">
            ...
            TechTrendz
                ...
                >
                    ...
                    <p className="relative hover:text-accent transition">
                        Cart
                        {totalQuantity > 0 && (
                            <span className="absolute -top-2 -right-4 bg-error text-secondary text-xs rounded-full w-5 h-5 flex items-center justify-center">
                                {totalQuantity}
                    ...
                    {user && (
                        ...
                        //     Profile
                        // </Link>
                        <p to="/profile" className="hover:text-accent transition">
                            Profile
                        </p>
                    )}
                    {isAdmin() && (
                        ...
                        //     Admin
                        // </Link>
                        <p to="/admin" className="hover:text-accent transition">
                            Admin
                        </p>
                    )}
                    {user ? (
                        ...
                        //     Login
                        // </Link>
                        <p to="/login" className="hover:text-accent transition">
                            Login
                        </p>
                    )}
                </div>
