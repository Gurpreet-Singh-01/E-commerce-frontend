...
const Button = ({
  ...
  const baseStyles =
    'font-semibold rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 font-text';
  const variantStyles = {
    primary:
      'bg-primary text-secondary hover:bg-primary-dark focus:ring-primary',
    secondary:
      'bg-neutral-light text-neutral-dark hover:bg-neutral/30 focus:ring-neutral',
